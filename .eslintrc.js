...
module.exports = {
    ...
    "rules": {
        ...
        "max-nested-callbacks": [1, 15], // specify the maximum depth callbacks can be nested (off by default)
        ...
        //"max-len": [0, 120, 2], // specify the maximum length of a line in your program (off by default)
